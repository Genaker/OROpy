...
class OroProdVsbResolv(Base):
    __tablename__ = 'oro_prod_vsb_resolv'
    ...
    source_product_visibility = Column(ForeignKey('oro_product_visibility.id', ondelete='CASCADE'), index=True)
    ...
    oro_product_visibility = relationship('OroProductVisibility')
