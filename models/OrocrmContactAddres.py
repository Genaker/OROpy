...
class OrocrmContactAddres(Base):
    __tablename__ = 'orocrm_contact_address'

    id = Column(Integer, primary_key=True, server_default=text("nextval('orocrm_contact_address_id_seq'::regclass)"))
    ...
    oro_address_type = relationship('OroAddressType', secondary='orocrm_contact_adr_to_adr_type')
