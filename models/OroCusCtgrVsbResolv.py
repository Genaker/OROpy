...
class OroCusCtgrVsbResolv(Base):
    __tablename__ = 'oro_cus_ctgr_vsb_resolv'
    ...
    source_category_visibility = Column(ForeignKey('oro_cus_category_visibility.id', ondelete='CASCADE'), index=True)
    ...
    oro_cus_category_visibility = relationship('OroCusCategoryVisibility')
