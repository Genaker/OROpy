...
class OroOauth2AuthCode(Base):
    __tablename__ = 'oro_oauth2_auth_code'

    id = Column(Integer, primary_key=True, server_default=text("nextval('oro_oauth2_auth_code_id_seq'::regclass)"))
