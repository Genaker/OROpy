...
class OroProductProdSDescr(Base):
    __tablename__ = 'oro_product_prod_s_descr'

    id = Column(Integer, primary_key=True, server_default=text("nextval('oro_product_prod_s_descr_id_seq'::regclass)"))
