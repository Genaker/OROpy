...
class OroWebsiteSearchDatetime(Base):
    __tablename__ = 'oro_website_search_datetime'
    __table_args__ = (
        Index('oro_website_search_datetime_item_field_idx', 'item_id', 'field'),
    )

    id = Column(Integer, primary_key=True, server_default=text("nextval('oro_website_search_datetime_id_seq'::regclass)"))
