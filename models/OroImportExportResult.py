...
class OroImportExportResult(Base):
    __tablename__ = 'oro_import_export_result'

    id = Column(Integer, primary_key=True, server_default=text("nextval('oro_import_export_result_id_seq'::regclass)"))
