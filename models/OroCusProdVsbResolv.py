...
class OroCusProdVsbResolv(Base):
    __tablename__ = 'oro_cus_prod_vsb_resolv'
    ...
    source_product_visibility = Column(ForeignKey('oro_cus_product_visibility.id', ondelete='CASCADE'), index=True)
    ...
    oro_cus_product_visibility = relationship('OroCusProductVisibility')
